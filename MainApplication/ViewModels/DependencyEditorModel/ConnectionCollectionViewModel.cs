...
namespace MainApplication.ViewModels.DependencyEditorModel
{
    ...
    public class ConnectionCollectionViewModel : ViewModelBase
    {
        ...
        /// 接続線管理ViewModelを生成する。
        /// </summary>
        public ConnectionCollectionViewModel(UndoRedoManager undoRedo, DependencyEditorViewModel editor)
        {
        ...
        /// </summary>
        public static void UpdateConnectionsForNode(TaskNodeViewModel node)
        {
